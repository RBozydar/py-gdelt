...
- Resolve current Ruff findings in event actor construction and parser error handling without changing parsing behavior.
- Format tracked Markdown code examples for current Ruff compatibility.
